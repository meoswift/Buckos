...
public class Suggestion {
    ...
    public static List<Suggestion> getMovieSuggestions() {
        ...
        suggestions.add(new Suggestion("Casablanca (1942)", "https://rooftopfilmclub.com/wp-content/uploads/2018/03/giphy-2.gif", "This romantic hit, starring Humphrey Bogart and Ingrid Bergman, is set during World War II and follows an American expat as he is torn between his love of an ex-girlfriend and helping her Czech Resistance leader husband escape Nazis."));
